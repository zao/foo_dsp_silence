...
struct t_dsp_silence_params
{
    ...
    t_dsp_silence_params(t_uint32 p_ms_post = 2000, t_uint32 p_ms_pre = 0, pfc::string8 p_skip_subpaths = "")
      : m_ms_post(p_ms_post)
      , m_ms_pre(p_ms_pre)
    ...
    {
        return m_ms_post == rhs.m_ms_post && m_ms_pre == rhs.m_ms_pre && m_skip_subpaths == rhs.m_skip_subpaths;
    }
    ...
    bool to_preset(dsp_preset& p_data)
    {
        ...
        std::span<char const> s{ m_skip_subpaths.get_ptr(), (size_t)m_skip_subpaths.get_length() + 1 };
...
void
split_string_on(pfc::list_t<pfc::string8>& out, char sep, pfc::string8 const& str)
{
    out.remove_all();
...
class dsp_silence : public dsp_impl_base
{
  ...
  public:
    ...
    static GUID g_get_guid()
    {
        ...
        static const GUID guid = { 0x750fbc09, 0x5337, 0x42d5, { 0x9a, 0xf, 0x9e, 0x76, 0x61, 0x1d, 0x7e, 0xc2 } };
        return guid;
    }
...
#pragma warning(pop)
    ...
    t_uint32 frame_count(float seconds) { return (t_uint32)(m_srate * seconds); }

    t_uint32 sample_count(float seconds) { return (t_uint32)(m_nch * m_srate * seconds); }
    ...
    {
        post_insert_impl(playback_state::end_of_track, playback_state::end_of_playback);
    }

    virtual void on_endofplayback(abort_callback&)
    {
        post_insert_impl(playback_state::end_of_playback, playback_state::end_of_track);
    }
